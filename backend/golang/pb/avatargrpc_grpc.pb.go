...
type AvatarServiceClient interface {
	GetAvatars(ctx context.Context, in *EmptyAvatar, opts ...grpc.CallOption) (*AvatarsResponse, error)
	GetOneAvatar(ctx context.Context, in *AvatarId, opts ...grpc.CallOption) (*AvatarResponseOne, error)
}
...
func (c *avatarServiceClient) GetAvatars(ctx context.Context, in *EmptyAvatar, opts ...grpc.CallOption) (*AvatarsResponse, error) {
	out := new(AvatarsResponse)
	err := c.cc.Invoke(ctx, "/protogrpc.AvatarService/GetAvatars", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *avatarServiceClient) GetOneAvatar(ctx context.Context, in *AvatarId, opts ...grpc.CallOption) (*AvatarResponseOne, error) {
	out := new(AvatarResponseOne)
	err := c.cc.Invoke(ctx, "/protogrpc.AvatarService/GetOneAvatar", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AvatarServiceServer interface {
	GetAvatars(context.Context, *EmptyAvatar) (*AvatarsResponse, error)
	GetOneAvatar(context.Context, *AvatarId) (*AvatarResponseOne, error)
...
func (UnimplementedAvatarServiceServer) GetAvatars(context.Context, *EmptyAvatar) (*AvatarsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAvatars not implemented")
}
func (UnimplementedAvatarServiceServer) GetOneAvatar(context.Context, *AvatarId) (*AvatarResponseOne, error) {
...
func _AvatarService_GetAvatars_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protogrpc.AvatarService/GetAvatars",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AvatarServiceServer).GetAvatars(ctx, req.(*EmptyAvatar))
	}
	return interceptor(ctx, in, info, handler)
}

func _AvatarService_GetOneAvatar_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AvatarId)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AvatarServiceServer).GetOneAvatar(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protogrpc.AvatarService/GetOneAvatar",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AvatarServiceServer).GetOneAvatar(ctx, req.(*AvatarId))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AvatarService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "protogrpc.AvatarService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AvatarService_GetOneAvatar_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "avatargrpc.proto",
}
